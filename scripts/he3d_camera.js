...
he3d.camera = function(s) {
	...
	this.mvpMatrix = he3d.m.mat4.create();
...
he3d.camera.prototype.readInput = function() {
	...
	if (he3d.i.keys[he3d.e.keys.LEFT_ARROW]) this.angle[1] += this.k_turnspeed * he3d.timer.delta;
	if (he3d.i.keys[he3d.e.keys.RIGHT_ARROW])this.angle[1] -= this.k_turnspeed * he3d.timer.delta;
...
he3d.camera.prototype.reset = function() {
	...
	this.invRotMat = he3d.m.mat3.create();
...
he3d.camera.prototype.toMVP = function() {
	he3d.m.mat4.multiply(he3d.r.pMatrix, he3d.r.mvMatrix, this.mvpMatrix);
	return this;
};
...
he3d.camera.prototype.update = function() {
	...
	if (this.type=='quat') {
		he3d.m.quat4.eulerAngleCreate(this.angle[0], this.angle[1], 0, this.qrot);
		he3d.m.quat4.multiplyVec3(this.qrot, this.delta);
		he3d.m.quat4.toMat4_broke(this.qrot, this.camMat);
...
he3d.camera.prototype.view = function() {
	if (this.type == 'quat') {
		...
		he3d.m.mat4.toInverseMat3(he3d.r.mvMatrix, he3d.m.mat3.identity(this.invRotMat));
