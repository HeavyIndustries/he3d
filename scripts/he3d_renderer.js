...
he3d.r.listCaps= function() {
	he3d.log('NOTICE', "GL Version:",
		he3d.gl.getParameter(he3d.gl.VERSION));
	he3d.log('NOTICE', "GL Vendor:",
		he3d.gl.getParameter(he3d.gl.VENDOR));
	he3d.log('NOTICE', "GL Renderer:",
		he3d.gl.getParameter(he3d.gl.RENDERER));
	he3d.log('NOTICE', "GL Shader Version:",
		he3d.gl.getParameter(he3d.gl.SHADING_LANGUAGE_VERSION));
	he3d.log('NOTICE', "GL Max Vertex Attributes:",
		he3d.gl.getParameter(he3d.gl.MAX_VERTEX_ATTRIBS));
	...
	he3d.log('NOTICE', "\tPremultipled Alpha:",
		he3d.r.glAttribs.premultipliedAlpha + " (Requested: " +
		he3d.r.glOpts.premultipliedAlpha + ")");
...
he3d.r.targets.create = function(o) {
	...
	if (targ.texture)
		he3d.gl.framebufferTexture2D(he3d.gl.FRAMEBUFFER, he3d.gl.COLOR_ATTACHMENT0,
			he3d.gl.TEXTURE_2D, he3d.t.textures[targ.texture].texture, 0);
...
he3d.r.setFXAA = function(fxaa) {
	if (fxaa == undefined)
		fxaa = !he3d.fx.postProcessing.options.fxaa;
	he3d.fx.postProcessing.options.fxaa = fxaa;
	try {
...
he3d.r.windowResize = function(e) {
	...
	if (he3d.r.fullscreen) {
		...
		// Nothings changed!
		if (!he3d.canvas || !he3d.canvas.height ||
			(he3d.canvas.height == he3d.r.windowSize[1] &&
